...
<p>Missing Collector User (with non-scraped/API update method): <a href="{{ route('location.index', ['collector_user_id' => 0, 'data_update_method_id' => '[2,3,4]']) }}">{{ \App\Models\Location::whereNull('collector_user_id')->whereIn('data_update_method_id',[2,3,4])->count() }}</a></p>
